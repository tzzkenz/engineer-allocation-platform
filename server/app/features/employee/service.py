...
class EmployeeService:
    ...
    async def create(self, employee_data: dict[str, Any]) -> Employee:
        ...
        if "date_of_joining" in employee_data:
            employee_data["date_of_joining"] = _coerce_date(employee_data["date_of_joining"])
        ...
        try:
            ...
            raise Exception("Database integrity violation occurred while creating employee")
    ...
    async def update(self, employee_id: int, update_data: dict[str, Any]) -> Employee:
        ...
        if "date_of_joining" in filtered_updates:
            filtered_updates["date_of_joining"] = _coerce_date(filtered_updates["date_of_joining"])
    ...
    async def change_password(self, employee_id: int, passwords: dict[str, Any]) -> None:
        employee = await self.get(employee_id)
